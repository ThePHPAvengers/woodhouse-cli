...
class ModuleCommandTest extends \PHPUnit_Framework_TestCase
{
    public function testExecuteSave()
    {
        ...
        $Woodhouse = new Woodhouse(new Application(), $this->provideServices($executor));

        $this->assertNull($Woodhouse->getServices()['module_manager']->get('test'));


        $command = $Woodhouse->getApplication()->find('module');
        ...
        $this->assertNotNull($Woodhouse->getServices()['module_manager']->get('test'));
        $this->assertSame(
    ...
    public function testExecuteRemove()
    {
        ...
        $Woodhouse = new Woodhouse(new Application(), $this->provideServices($executor, $questionHelper));
