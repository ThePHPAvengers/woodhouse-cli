...
class ModuleProcedureTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $moduleManager = $this->getMockBuilder('Woodhouse\Module\ModuleManager')->disableOriginalConstructor()->getMock();
        $composer = $this->getMockBuilder('Woodhouse\Project\Composer\Composer')->disableOriginalConstructor()->getMock();
        $balloonFactory = new BalloonFactory(new DummyFileReaderFactory(new DummyFileReader()));
        $modulesSorter = $this->getMockBuilder('Woodhouse\Module\ModulesSorter')->disableOriginalConstructor()->getMock();
    ...
    public function testImportWithCorrectModulePackage()
    {
        ...
        $data->write('{
          "package": "ThePHPAvengers/Woodhouse-module-git",
          "description": "Git module",
          "dependencies": [

          ],
          "tasks": [
            "Woodhouse\\\Git\\\GitTask"
          ]
        }');
        ...
        $balloonFactory->expects($this->at(0))
            ->method('create')
            ->with('COMPOSER_HOME/vendor/none/none/.Woodhouse.json')
    ...
    public function testImportWithDependencies()
    {
        ...
        $balloonFactory->expects($this->at(1))
            ->method('create')
            ->with('COMPOSER_HOME/vendor/dependency/1/.Woodhouse.json')
        ...
        $balloonFactory->expects($this->at(2))
            ->method('create')
            ->with('COMPOSER_HOME/vendor/dependency/2/.Woodhouse.json')
