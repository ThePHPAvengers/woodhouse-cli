...
class InstallingTest extends \PHPUnit_Framework_TestCase
{
    public function testExecuteWithModule()
    {
        ...
        $this->assertSame(
            "Starting modules installation\nModule \"ThePHPAvengers/Woodhouse-module-git\" already installed\nModule \"ThePHPAvengers/Woodhouse-module-cleaner\" already installed\n",
            $output->fetch()
        );
    }
    ...
    private function provideModuleManager($hasModule)
    {
        ...
        $moduleManager = $this->getMockBuilder('Woodhouse\Module\ModuleManager')
    ...
    {
        $moduleProcedure = $this->getMockBuilder('Woodhouse\Module\ModuleProcedure')->disableOriginalConstructor()->getMock();
