...
class NewCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDefault()
    {
        ...
        $Woodhouse = new Woodhouse($application, $this->provideServices($questionHelper, $git, true), $executor);
        ...
        $this->assertContains('Installing project vendor/package from ThePHPAvengers/php-lib-bootstrap', $commandTester->getDisplay());
        ...
        $this->assertRegExp('/Generated by Woodhouse in \d+\.\d{2} sec. Banzai!/', $commandTester->getDisplay());

        /**
         * @var Project $project
         */
        $project = $Woodhouse->getServices()['project'];
        $this->assertSame('vendor/package', $project->getName());
        $this->assertSame('ThePHPAvengers/php-lib-bootstrap', $project->getBootstrap()->getPackage());
    ...
    public function testFilled()
    {
        ...
        $application = new Application();
        $Woodhouse = new Woodhouse($application, $this->provideServices($questionHelper, $git, false), $executor);
